        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for img_data in images:
                ...
                try:
                    ...
                    st.warning(f"Could not add image {img_data['filename']} to Excel: {str(e)}")
...
def main():
    ...
    st.markdown("Upload a PDF file to extract tables and images into downloadable formats.")
        ...
        if st.button("🚀 Start Extraction", type="primary"):
            ...
            with st.spinner("Processing PDF..."):
                ...
                if tables or images:
                        ...
                        for i, img_data in enumerate(images):
                            with cols[i % 3]:
                                try:
                                    ...
                                    st.image(img, caption=f"Page {img_data['page']}, Image {img_data['index'] + 1}")
                                except Exception as e:
                    ...
                    with col1:
                        if tables or images:
                            st.info("Creating Excel file with tables and images...")
                            excel_path = create_excel_with_tables_and_images(tables, images)
